...
| §3.8 Uncertainty Models (`scenarios/inflow_models.parquet`)            | [02-data-model/input-scenarios.md](02-data-model/input-scenarios.md)                     |                                                              |
...
| §11.2 Per-Rank Scenario Distribution         | [03-architecture/scenario-generation.md](03-architecture/scenario-generation.md) |       |
