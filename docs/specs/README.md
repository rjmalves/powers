...
```
draft --> under-review --> approved --> needs-re-review
               |                ^            |
               +-> needs-changes -+           +-> approved (after re-review)
               |
...
| [upper-bound-evaluation.md](01-math/upper-bound-evaluation.md)   | approved |   235 | Inner approximation, Lipschitz interpolation, gap computation                |
...
| [extension-points.md](03-architecture/extension-points.md)               | approved |   268 | Variant selection, composition validation, dispatch mechanism          |
